...
function regJoinInd(sim) {
  var simple = "#simple"+sim;
  var detail = "#detail"+sim;
  var rule = "#rule"+sim;
  var reg = "#regJoinInd"+sim;
  var check = "#checkReg"+sim;
  $(document).ready(function(){
    $(reg).slideDown(800);
    $(check).fadeOut();
...
function regJoinIndClose(sim) {
  ...
  var teams = "#regJoinInd"+sim+" .teams";
  var codes = "#regJoinInd"+sim+" .codes";
  var events = "#regJoinInd"+sim+" .events";
  var catgs = "#regJoinInd"+sim+" .catg";
  var emails = "#regJoinInd"+sim+" .emails";
  var contacts = "#regJoinInd"+sim+" .contacts";
  var colleges = "#regJoinInd"+sim+" .colleges";
  var years = "#regJoinInd"+sim+" .years";
  var courses = "#regJoinInd"+sim+" .courses";
  var songnames = "#regJoinInd"+sim+" .songname";
  var h1 = "#rule"+sim+" h1";
  var h2 = "#rule"+sim+" h2";
  $(h2).css("display", "none");
  var team = $(teams).val();
